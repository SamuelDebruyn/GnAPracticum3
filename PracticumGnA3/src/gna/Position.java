...
public class Position {
	 ...
	 * @param diagonal Include the diagonal neighbors or not (neighbors must exist in the image).
	 * @return An ArrayList with the neigbors of the current position.
	 */
	public ArrayList<Position> getNeighbors(int width, int height, boolean diagonal){
